...
class LoggerLevel(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    NoneLevel: _ClassVar[LoggerLevel]
...
class CardType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    NO_CARD: _ClassVar[CardType]
    YELLOW: _ClassVar[CardType]
    RED: _ClassVar[CardType]
...
class Ball(_message.Message):
    ...
    def __init__(self, position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., relative_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., seen_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., heard_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., velocity: _Optional[_Union[RpcVector2D, _Mapping]] = ..., seen_velocity: _Optional[_Union[RpcVector2D, _Mapping]] = ..., heard_velocity: _Optional[_Union[RpcVector2D, _Mapping]] = ..., pos_count: _Optional[int] = ..., seen_pos_count: _Optional[int] = ..., heard_pos_count: _Optional[int] = ..., vel_count: _Optional[int] = ..., seen_vel_count: _Optional[int] = ..., heard_vel_count: _Optional[int] = ..., lost_count: _Optional[int] = ..., ghost_count: _Optional[int] = ..., dist_from_self: _Optional[float] = ..., angle_from_self: _Optional[float] = ...) -> None: ...

class PenaltyKickState(_message.Message):
    __slots__ = ("on_field_side", "current_taker_side", "our_taker_counter", "their_taker_counter", "our_score", "their_score", "is_kick_taker")
    ON_FIELD_SIDE_FIELD_NUMBER: _ClassVar[int]
    CURRENT_TAKER_SIDE_FIELD_NUMBER: _ClassVar[int]
    OUR_TAKER_COUNTER_FIELD_NUMBER: _ClassVar[int]
    THEIR_TAKER_COUNTER_FIELD_NUMBER: _ClassVar[int]
    OUR_SCORE_FIELD_NUMBER: _ClassVar[int]
    THEIR_SCORE_FIELD_NUMBER: _ClassVar[int]
    IS_KICK_TAKER_FIELD_NUMBER: _ClassVar[int]
    on_field_side: Side
    ...
    their_score: int
    is_kick_taker: bool
    def __init__(self, on_field_side: _Optional[_Union[Side, str]] = ..., current_taker_side: _Optional[_Union[Side, str]] = ..., our_taker_counter: _Optional[int] = ..., their_taker_counter: _Optional[int] = ..., our_score: _Optional[int] = ..., their_score: _Optional[int] = ..., is_kick_taker: bool = ...) -> None: ...
...
class WorldModel(_message.Message):
    ...
    class TheirPlayersDictEntry(_message.Message):
        ...
        value: Player
        def __init__(self, key: _Optional[int] = ..., value: _Optional[_Union[Player, _Mapping]] = ...) -> None: ...
    class HeliosHomePositionsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: int
        value: RpcVector2D
        def __init__(self, key: _Optional[int] = ..., value: _Optional[_Union[RpcVector2D, _Mapping]] = ...) -> None: ...
    ...
    HELIOS_HOME_POSITIONS_FIELD_NUMBER: _ClassVar[int]
    OUR_DEFENSE_LINE_X_FIELD_NUMBER: _ClassVar[int]
    THEIR_DEFENSE_LINE_X_FIELD_NUMBER: _ClassVar[int]
    OUR_DEFENSE_PLAYER_LINE_X_FIELD_NUMBER: _ClassVar[int]
    THEIR_DEFENSE_PLAYER_LINE_X_FIELD_NUMBER: _ClassVar[int]
    KICKABLE_TEAMMATE_EXISTANCE_FIELD_NUMBER: _ClassVar[int]
    KICKABLE_OPPONENT_EXISTANCE_FIELD_NUMBER: _ClassVar[int]
    PENALTY_KICK_STATE_FIELD_NUMBER: _ClassVar[int]
    SEE_TIME_FIELD_NUMBER: _ClassVar[int]
    TIME_STOPPED_FIELD_NUMBER: _ClassVar[int]
    SET_PLAY_COUNT_FIELD_NUMBER: _ClassVar[int]
    GAME_MODE_SIDE_FIELD_NUMBER: _ClassVar[int]
    ...
    helios_home_positions: _containers.MessageMap[int, RpcVector2D]
...
class State(_message.Message):
    ...
    NEED_PREPROCESS_FIELD_NUMBER: _ClassVar[int]
    register_response: RegisterResponse
    world_model: WorldModel
    full_world_model: WorldModel
    need_preprocess: bool
    def __init__(self, register_response: _Optional[_Union[RegisterResponse, _Mapping]] = ..., world_model: _Optional[_Union[WorldModel, _Mapping]] = ..., full_world_model: _Optional[_Union[WorldModel, _Mapping]] = ..., need_preprocess: bool = ...) -> None: ...

class InitMessage(_message.Message):
    __slots__ = ("register_response", "debug_mode")
    REGISTER_RESPONSE_FIELD_NUMBER: _ClassVar[int]
    DEBUG_MODE_FIELD_NUMBER: _ClassVar[int]
    register_response: RegisterResponse
    debug_mode: bool
    def __init__(self, register_response: _Optional[_Union[RegisterResponse, _Mapping]] = ..., debug_mode: bool = ...) -> None: ...
...
class BallMessage(_message.Message):
    ...
    def __init__(self, ball_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., ball_velocity: _Optional[_Union[RpcVector2D, _Mapping]] = ...) -> None: ...
...
class PassMessage(_message.Message):
    ...
    ball_position: RpcVector2D
    ball_velocity: RpcVector2D
    def __init__(self, receiver_uniform_number: _Optional[int] = ..., receiver_point: _Optional[_Union[RpcVector2D, _Mapping]] = ..., ball_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., ball_velocity: _Optional[_Union[RpcVector2D, _Mapping]] = ...) -> None: ...
...
class GoalieMessage(_message.Message):
    ...
    def __init__(self, goalie_uniform_number: _Optional[int] = ..., goalie_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., goalie_body_direction: _Optional[float] = ...) -> None: ...
...
class GoalieAndPlayerMessage(_message.Message):
    ...
    def __init__(self, goalie_uniform_number: _Optional[int] = ..., goalie_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., goalie_body_direction: _Optional[float] = ..., player_uniform_number: _Optional[int] = ..., player_position: _Optional[_Union[RpcVector2D, _Mapping]] = ...) -> None: ...
...
class PassRequestMessage(_message.Message):
    ...
    def __init__(self, target_point: _Optional[_Union[RpcVector2D, _Mapping]] = ...) -> None: ...
...
class DribbleMessage(_message.Message):
    ...
    target_point: RpcVector2D
    queue_count: int
    def __init__(self, target_point: _Optional[_Union[RpcVector2D, _Mapping]] = ..., queue_count: _Optional[int] = ...) -> None: ...
...
class BallGoalieMessage(_message.Message):
    ...
    goalie_position: RpcVector2D
    goalie_body_direction: float
    def __init__(self, ball_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., ball_velocity: _Optional[_Union[RpcVector2D, _Mapping]] = ..., goalie_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., goalie_body_direction: _Optional[float] = ...) -> None: ...
...
class OnePlayerMessage(_message.Message):
    ...
    uniform_number: int
    position: RpcVector2D
    def __init__(self, uniform_number: _Optional[int] = ..., position: _Optional[_Union[RpcVector2D, _Mapping]] = ...) -> None: ...
...
class TwoPlayerMessage(_message.Message):
    ...
    def __init__(self, first_uniform_number: _Optional[int] = ..., first_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., second_uniform_number: _Optional[int] = ..., second_position: _Optional[_Union[RpcVector2D, _Mapping]] = ...) -> None: ...
...
class ThreePlayerMessage(_message.Message):
    ...
    def __init__(self, first_uniform_number: _Optional[int] = ..., first_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., second_uniform_number: _Optional[int] = ..., second_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., third_uniform_number: _Optional[int] = ..., third_position: _Optional[_Union[RpcVector2D, _Mapping]] = ...) -> None: ...
...
class SelfMessage(_message.Message):
    ...
    self_stamina: float
    def __init__(self, self_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., self_body_direction: _Optional[float] = ..., self_stamina: _Optional[float] = ...) -> None: ...
...
class TeammateMessage(_message.Message):
    ...
    position: RpcVector2D
    body_direction: float
    def __init__(self, uniform_number: _Optional[int] = ..., position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., body_direction: _Optional[float] = ...) -> None: ...
...
class BallPlayerMessage(_message.Message):
    ...
    player_position: RpcVector2D
    body_direction: float
    def __init__(self, ball_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., ball_velocity: _Optional[_Union[RpcVector2D, _Mapping]] = ..., uniform_number: _Optional[int] = ..., player_position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., body_direction: _Optional[float] = ...) -> None: ...
...
class AddPoint(_message.Message):
    ...
    point: RpcVector2D
    color: str
    def __init__(self, level: _Optional[_Union[LoggerLevel, str]] = ..., point: _Optional[_Union[RpcVector2D, _Mapping]] = ..., color: _Optional[str] = ...) -> None: ...
...
class AddLine(_message.Message):
    ...
    color: str
    def __init__(self, level: _Optional[_Union[LoggerLevel, str]] = ..., start: _Optional[_Union[RpcVector2D, _Mapping]] = ..., end: _Optional[_Union[RpcVector2D, _Mapping]] = ..., color: _Optional[str] = ...) -> None: ...
...
class AddArc(_message.Message):
    ...
    span_angel: float
    color: str
    def __init__(self, level: _Optional[_Union[LoggerLevel, str]] = ..., center: _Optional[_Union[RpcVector2D, _Mapping]] = ..., radius: _Optional[float] = ..., start_angle: _Optional[float] = ..., span_angel: _Optional[float] = ..., color: _Optional[str] = ...) -> None: ...
...
class AddCircle(_message.Message):
    ...
    color: str
    fill: bool
    def __init__(self, level: _Optional[_Union[LoggerLevel, str]] = ..., center: _Optional[_Union[RpcVector2D, _Mapping]] = ..., radius: _Optional[float] = ..., color: _Optional[str] = ..., fill: bool = ...) -> None: ...
...
class AddTriangle(_message.Message):
    ...
    color: str
    fill: bool
    def __init__(self, level: _Optional[_Union[LoggerLevel, str]] = ..., point1: _Optional[_Union[RpcVector2D, _Mapping]] = ..., point2: _Optional[_Union[RpcVector2D, _Mapping]] = ..., point3: _Optional[_Union[RpcVector2D, _Mapping]] = ..., color: _Optional[str] = ..., fill: bool = ...) -> None: ...
...
class AddSector(_message.Message):
    ...
    color: str
    fill: bool
    def __init__(self, level: _Optional[_Union[LoggerLevel, str]] = ..., center: _Optional[_Union[RpcVector2D, _Mapping]] = ..., min_radius: _Optional[float] = ..., max_radius: _Optional[float] = ..., start_angle: _Optional[float] = ..., span_angel: _Optional[float] = ..., color: _Optional[str] = ..., fill: bool = ...) -> None: ...
...
class AddMessage(_message.Message):
    ...
    message: str
    color: str
    def __init__(self, level: _Optional[_Union[LoggerLevel, str]] = ..., position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., message: _Optional[str] = ..., color: _Optional[str] = ...) -> None: ...
...
class Body_GoToPoint(_message.Message):
    ...
    def __init__(self, target_point: _Optional[_Union[RpcVector2D, _Mapping]] = ..., distance_threshold: _Optional[float] = ..., max_dash_power: _Optional[float] = ...) -> None: ...
...
class Body_SmartKick(_message.Message):
    ...
    max_steps: int
    def __init__(self, target_point: _Optional[_Union[RpcVector2D, _Mapping]] = ..., first_speed: _Optional[float] = ..., first_speed_threshold: _Optional[float] = ..., max_steps: _Optional[int] = ...) -> None: ...

class Bhv_BeforeKickOff(_message.Message):
    __slots__ = ("point",)
    POINT_FIELD_NUMBER: _ClassVar[int]
    point: RpcVector2D
    def __init__(self, point: _Optional[_Union[RpcVector2D, _Mapping]] = ...) -> None: ...
...
class Bhv_NeckBodyToPoint(_message.Message):
    ...
    point: RpcVector2D
    angle_buf: float
    def __init__(self, point: _Optional[_Union[RpcVector2D, _Mapping]] = ..., angle_buf: _Optional[float] = ...) -> None: ...
...
class Body_Dribble(_message.Message):
    ...
    dash_count: int
    dodge: bool
    def __init__(self, target_point: _Optional[_Union[RpcVector2D, _Mapping]] = ..., distance_threshold: _Optional[float] = ..., dash_power: _Optional[float] = ..., dash_count: _Optional[int] = ..., dodge: bool = ...) -> None: ...
...
class Body_GoToPointDodge(_message.Message):
    ...
    target_point: RpcVector2D
    dash_power: float
    def __init__(self, target_point: _Optional[_Union[RpcVector2D, _Mapping]] = ..., dash_power: _Optional[float] = ...) -> None: ...
...
class Body_HoldBall(_message.Message):
    ...
    def __init__(self, do_turn: bool = ..., turn_target_point: _Optional[_Union[RpcVector2D, _Mapping]] = ..., kick_target_point: _Optional[_Union[RpcVector2D, _Mapping]] = ...) -> None: ...
...
class Body_Intercept(_message.Message):
    ...
    def __init__(self, save_recovery: bool = ..., face_point: _Optional[_Union[RpcVector2D, _Mapping]] = ...) -> None: ...
...
class Body_KickOneStep(_message.Message):
    ...
    first_speed: float
    force_mode: bool
    def __init__(self, target_point: _Optional[_Union[RpcVector2D, _Mapping]] = ..., first_speed: _Optional[float] = ..., force_mode: bool = ...) -> None: ...
...
class Body_TackleToPoint(_message.Message):
    ...
    min_speed: float
    def __init__(self, target_point: _Optional[_Union[RpcVector2D, _Mapping]] = ..., min_probability: _Optional[float] = ..., min_speed: _Optional[float] = ...) -> None: ...
...
class Body_TurnToPoint(_message.Message):
    ...
    target_point: RpcVector2D
    cycle: int
    def __init__(self, target_point: _Optional[_Union[RpcVector2D, _Mapping]] = ..., cycle: _Optional[int] = ...) -> None: ...
...
class Neck_OffensiveInterceptNeck(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
...
class HeliosOffensivePlanner(_message.Message):
    __slots__ = ("direct_pass", "lead_pass", "through_pass", "short_dribble", "long_dribble", "cross", "simple_pass", "simple_dribble", "simple_shoot", "server_side_decision", "max_depth", "max_nodes", "evaluation")
    ...
    def __init__(self, direct_pass: bool = ..., lead_pass: bool = ..., through_pass: bool = ..., short_dribble: bool = ..., long_dribble: bool = ..., cross: bool = ..., simple_pass: bool = ..., simple_dribble: bool = ..., simple_shoot: bool = ..., server_side_decision: bool = ..., max_depth: _Optional[int] = ..., max_nodes: _Optional[int] = ..., evaluation: _Optional[_Union[PlannerEvaluation, _Mapping]] = ...) -> None: ...

class OpponentEffector(_message.Message):
    __slots__ = ("negetive_effect_by_distance", "negetive_effect_by_distance_based_on_first_layer", "negetive_effect_by_reach_steps", "negetive_effect_by_reach_steps_based_on_first_layer")
    NEGETIVE_EFFECT_BY_DISTANCE_FIELD_NUMBER: _ClassVar[int]
    NEGETIVE_EFFECT_BY_DISTANCE_BASED_ON_FIRST_LAYER_FIELD_NUMBER: _ClassVar[int]
    NEGETIVE_EFFECT_BY_REACH_STEPS_FIELD_NUMBER: _ClassVar[int]
    NEGETIVE_EFFECT_BY_REACH_STEPS_BASED_ON_FIRST_LAYER_FIELD_NUMBER: _ClassVar[int]
    negetive_effect_by_distance: _containers.RepeatedScalarFieldContainer[float]
    negetive_effect_by_distance_based_on_first_layer: bool
    negetive_effect_by_reach_steps: _containers.RepeatedScalarFieldContainer[float]
    negetive_effect_by_reach_steps_based_on_first_layer: bool
    def __init__(self, negetive_effect_by_distance: _Optional[_Iterable[float]] = ..., negetive_effect_by_distance_based_on_first_layer: bool = ..., negetive_effect_by_reach_steps: _Optional[_Iterable[float]] = ..., negetive_effect_by_reach_steps_based_on_first_layer: bool = ...) -> None: ...

class ActionTypeEffector(_message.Message):
    __slots__ = ("direct_pass", "lead_pass", "through_pass", "short_dribble", "long_dribble", "cross", "hold")
    DIRECT_PASS_FIELD_NUMBER: _ClassVar[int]
    LEAD_PASS_FIELD_NUMBER: _ClassVar[int]
    THROUGH_PASS_FIELD_NUMBER: _ClassVar[int]
    SHORT_DRIBBLE_FIELD_NUMBER: _ClassVar[int]
    ...
    cross: float
    hold: float
    def __init__(self, direct_pass: _Optional[float] = ..., lead_pass: _Optional[float] = ..., through_pass: _Optional[float] = ..., short_dribble: _Optional[float] = ..., long_dribble: _Optional[float] = ..., cross: _Optional[float] = ..., hold: _Optional[float] = ...) -> None: ...

class TeammateEffector(_message.Message):
    __slots__ = ("coefficients", "apply_based_on_first_layer")
    class CoefficientsEntry(_message.Message):
        __slots__ = ("key", "value")
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: int
    ...
    APPLY_BASED_ON_FIRST_LAYER_FIELD_NUMBER: _ClassVar[int]
    coefficients: _containers.ScalarMap[int, float]
    apply_based_on_first_layer: bool
    def __init__(self, coefficients: _Optional[_Mapping[int, float]] = ..., apply_based_on_first_layer: bool = ...) -> None: ...

class PlannerEvaluationEffector(_message.Message):
    __slots__ = ("opponent_effector", "action_type_effector", "teammate_effector")
    OPPONENT_EFFECTOR_FIELD_NUMBER: _ClassVar[int]
    ACTION_TYPE_EFFECTOR_FIELD_NUMBER: _ClassVar[int]
    TEAMMATE_EFFECTOR_FIELD_NUMBER: _ClassVar[int]
    opponent_effector: OpponentEffector
    action_type_effector: ActionTypeEffector
    teammate_effector: TeammateEffector
    def __init__(self, opponent_effector: _Optional[_Union[OpponentEffector, _Mapping]] = ..., action_type_effector: _Optional[_Union[ActionTypeEffector, _Mapping]] = ..., teammate_effector: _Optional[_Union[TeammateEffector, _Mapping]] = ...) -> None: ...

class HeliosFieldEvaluator(_message.Message):
    __slots__ = ("x_coefficient", "ball_dist_to_goal_coefficient", "effective_max_ball_dist_to_goal")
    X_COEFFICIENT_FIELD_NUMBER: _ClassVar[int]
    BALL_DIST_TO_GOAL_COEFFICIENT_FIELD_NUMBER: _ClassVar[int]
    EFFECTIVE_MAX_BALL_DIST_TO_GOAL_FIELD_NUMBER: _ClassVar[int]
    x_coefficient: float
    ball_dist_to_goal_coefficient: float
    effective_max_ball_dist_to_goal: float
    def __init__(self, x_coefficient: _Optional[float] = ..., ball_dist_to_goal_coefficient: _Optional[float] = ..., effective_max_ball_dist_to_goal: _Optional[float] = ...) -> None: ...

class MatrixFieldEvaluatorY(_message.Message):
    __slots__ = ("evals",)
    EVALS_FIELD_NUMBER: _ClassVar[int]
    evals: _containers.RepeatedScalarFieldContainer[float]
    def __init__(self, evals: _Optional[_Iterable[float]] = ...) -> None: ...

class MatrixFieldEvaluator(_message.Message):
    __slots__ = ("evals",)
    EVALS_FIELD_NUMBER: _ClassVar[int]
    evals: _containers.RepeatedCompositeFieldContainer[MatrixFieldEvaluatorY]
    def __init__(self, evals: _Optional[_Iterable[_Union[MatrixFieldEvaluatorY, _Mapping]]] = ...) -> None: ...

class PlannerFieldEvaluator(_message.Message):
    __slots__ = ("helios_field_evaluator", "matrix_field_evaluator")
    HELIOS_FIELD_EVALUATOR_FIELD_NUMBER: _ClassVar[int]
    MATRIX_FIELD_EVALUATOR_FIELD_NUMBER: _ClassVar[int]
    helios_field_evaluator: HeliosFieldEvaluator
    matrix_field_evaluator: MatrixFieldEvaluator
    def __init__(self, helios_field_evaluator: _Optional[_Union[HeliosFieldEvaluator, _Mapping]] = ..., matrix_field_evaluator: _Optional[_Union[MatrixFieldEvaluator, _Mapping]] = ...) -> None: ...

class PlannerEvaluation(_message.Message):
    __slots__ = ("effectors", "field_evaluators")
    EFFECTORS_FIELD_NUMBER: _ClassVar[int]
    FIELD_EVALUATORS_FIELD_NUMBER: _ClassVar[int]
    effectors: PlannerEvaluationEffector
    field_evaluators: PlannerFieldEvaluator
    def __init__(self, effectors: _Optional[_Union[PlannerEvaluationEffector, _Mapping]] = ..., field_evaluators: _Optional[_Union[PlannerFieldEvaluator, _Mapping]] = ...) -> None: ...
...
class PlayerAction(_message.Message):
    ...
    HELIOS_OFFENSIVE_PLANNER_FIELD_NUMBER: _ClassVar[int]
    ...
    HELIOS_COMMUNICATION_FIELD_NUMBER: _ClassVar[int]
    BHV_DO_FORCE_KICK_FIELD_NUMBER: _ClassVar[int]
    BHV_DO_HEARD_PASS_RECIEVE_FIELD_NUMBER: _ClassVar[int]
    HELIOS_BASIC_TACKLE_FIELD_NUMBER: _ClassVar[int]
    NECK_OFFENSIVE_INTERCEPT_NECK_FIELD_NUMBER: _ClassVar[int]
    dash: Dash
    turn: Turn
    kick: Kick
    tackle: Tackle
...
class PlayerActions(_message.Message):
    ...
    def __init__(self, actions: _Optional[_Iterable[_Union[PlayerAction, _Mapping]]] = ..., ignore_preprocess: bool = ..., ignore_doforcekick: bool = ..., ignore_doHeardPassRecieve: bool = ..., ignore_doIntention: bool = ..., ignore_shootInPreprocess: bool = ...) -> None: ...

class ChangePlayerType(_message.Message):
    __slots__ = ("uniform_number", "type")
    UNIFORM_NUMBER_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
    uniform_number: int
    type: int
    def __init__(self, uniform_number: _Optional[int] = ..., type: _Optional[int] = ...) -> None: ...

class DoHeliosSubstitute(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class DoHeliosSayPlayerTypes(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class CoachAction(_message.Message):
    __slots__ = ("change_player_types", "do_helios_substitute", "do_helios_say_player_types")
    CHANGE_PLAYER_TYPES_FIELD_NUMBER: _ClassVar[int]
    DO_HELIOS_SUBSTITUTE_FIELD_NUMBER: _ClassVar[int]
    DO_HELIOS_SAY_PLAYER_TYPES_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, change_player_types: _Optional[_Union[ChangePlayerType, _Mapping]] = ..., do_helios_substitute: _Optional[_Union[DoHeliosSubstitute, _Mapping]] = ..., do_helios_say_player_types: _Optional[_Union[DoHeliosSayPlayerTypes, _Mapping]] = ...) -> None: ...

class CoachActions(_message.Message):
    __slots__ = ("actions",)
    ACTIONS_FIELD_NUMBER: _ClassVar[int]
    actions: _containers.RepeatedCompositeFieldContainer[CoachAction]
    def __init__(self, actions: _Optional[_Iterable[_Union[CoachAction, _Mapping]]] = ...) -> None: ...

class DoKickOff(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class DoMoveBall(_message.Message):
    __slots__ = ("position", "velocity")
    POSITION_FIELD_NUMBER: _ClassVar[int]
    VELOCITY_FIELD_NUMBER: _ClassVar[int]
    position: RpcVector2D
    velocity: RpcVector2D
    def __init__(self, position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., velocity: _Optional[_Union[RpcVector2D, _Mapping]] = ...) -> None: ...

class DoMovePlayer(_message.Message):
    __slots__ = ("our_side", "uniform_number", "position", "body_direction")
    OUR_SIDE_FIELD_NUMBER: _ClassVar[int]
    UNIFORM_NUMBER_FIELD_NUMBER: _ClassVar[int]
    POSITION_FIELD_NUMBER: _ClassVar[int]
    BODY_DIRECTION_FIELD_NUMBER: _ClassVar[int]
    ...
    position: RpcVector2D
    body_direction: float
    def __init__(self, our_side: bool = ..., uniform_number: _Optional[int] = ..., position: _Optional[_Union[RpcVector2D, _Mapping]] = ..., body_direction: _Optional[float] = ...) -> None: ...

class DoRecover(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class DoChangeMode(_message.Message):
    __slots__ = ("game_mode_type", "side")
    GAME_MODE_TYPE_FIELD_NUMBER: _ClassVar[int]
    SIDE_FIELD_NUMBER: _ClassVar[int]
    game_mode_type: GameModeType
    side: Side
    def __init__(self, game_mode_type: _Optional[_Union[GameModeType, str]] = ..., side: _Optional[_Union[Side, str]] = ...) -> None: ...

class DoChangePlayerType(_message.Message):
    __slots__ = ("our_side", "uniform_number", "type")
    OUR_SIDE_FIELD_NUMBER: _ClassVar[int]
    UNIFORM_NUMBER_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
    our_side: bool
    uniform_number: int
    type: int
    def __init__(self, our_side: bool = ..., uniform_number: _Optional[int] = ..., type: _Optional[int] = ...) -> None: ...

class TrainerAction(_message.Message):
    __slots__ = ("do_kick_off", "do_move_ball", "do_move_player", "do_recover", "do_change_mode", "do_change_player_type")
    DO_KICK_OFF_FIELD_NUMBER: _ClassVar[int]
    DO_MOVE_BALL_FIELD_NUMBER: _ClassVar[int]
    DO_MOVE_PLAYER_FIELD_NUMBER: _ClassVar[int]
    DO_RECOVER_FIELD_NUMBER: _ClassVar[int]
    DO_CHANGE_MODE_FIELD_NUMBER: _ClassVar[int]
    DO_CHANGE_PLAYER_TYPE_FIELD_NUMBER: _ClassVar[int]
...
class ServerParam(_message.Message):
    ...
    GOAL_AREA_WIDTH_FIELD_NUMBER: _ClassVar[int]
    GOAL_AREA_LENGTH_FIELD_NUMBER: _ClassVar[int]
    CENTER_CIRCLE_R_FIELD_NUMBER: _ClassVar[int]
    GOAL_POST_RADIUS_FIELD_NUMBER: _ClassVar[int]
    PITCH_MARGIN_FIELD_NUMBER: _ClassVar[int]
    register_response: RegisterResponse
